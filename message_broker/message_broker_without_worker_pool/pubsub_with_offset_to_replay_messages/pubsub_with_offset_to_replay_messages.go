...
func main() {
	...
	// ============================================
	//tbh the messages would be published from
	//publisher side who will be calling the
	//publish method of the broker
	//but here just for simplicity
	//purpose emitting the client
	//which publishes to broker
	//I mean assuming main itself is pubslisher
